...
import ru.brobrocode.cadra.client.model.ResumeShouldSendSmsContainer;
...
public interface ResumeShouldSendSmsApi {

    /**
     * GET /resume_should_send_sms : Получить информацию о телефоне соискателя
     *
     * @param phone Номер телефона в любом формате (required)
     ...
     */
    @Operation(
        operationId = "getApplicantPhoneInfo",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Успешный ответ", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ResumeShouldSendSmsContainer.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/resume_should_send_sms",
        produces = { "application/json" }
    )
    
    ResponseEntity<ResumeShouldSendSmsContainer> getApplicantPhoneInfo(
        @NotNull @Parameter(name = "phone", description = "Номер телефона в любом формате", required = true, in = ParameterIn.QUERY) @Valid @RequestParam(value = "phone", required = true) String phone,
