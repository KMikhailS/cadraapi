...
import ru.brobrocode.cadra.client.model.DictionariesDistrictItem;
...
public interface DistrictsApi {
    ...
    /**
     * GET /districts : Список районов во всех городах
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Успешный ответ", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = DictionariesDistrictItem.class)))
            })
        },
        security = {
    ...
    ResponseEntity<List<DictionariesDistrictItem>> getAllDistricts(
