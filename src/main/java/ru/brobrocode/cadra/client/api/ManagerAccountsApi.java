...
import ru.brobrocode.cadra.client.model.ManagerAccounts;
...
public interface ManagerAccountsApi {
     ...
     */
    @Operation(
        operationId = "getManagerAccounts",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Успешный ответ", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ManagerAccounts.class))
            }),
    ...
    @RequestMapping(
        ...
        value = "/manager_accounts/mine",
        produces = { "application/json" }
    )
    
    ResponseEntity<ManagerAccounts> getManagerAccounts(
