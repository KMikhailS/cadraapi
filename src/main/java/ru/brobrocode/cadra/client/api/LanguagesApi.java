...
import ru.brobrocode.cadra.client.model.DictionariesLangItem;
...
public interface LanguagesApi {
    ...
    /**
     * GET /languages : Список всех языков
     *
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Успешный ответ", content = {
                @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = DictionariesLangItem.class)))
            })
        },
        security = {
    ...
    ResponseEntity<List<DictionariesLangItem>> getLanguages(
