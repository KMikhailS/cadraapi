...
import ru.brobrocode.cadra.client.model.VacanciesVacancyConditions;

@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-17T15:41:09.394389505+05:00[Asia/Yekaterinburg]", comments = "Generator version: 7.6.0")
@Validated
@Tag(name = "Управление вакансиями", description = "Методы для работы с вакансиями от имени менеджера работодателя. ## Восстановление вакансии из архива  Для восстановления вакансии необходимо использовать метод публикации и руководствоваться правилом использования параметра previous_id, описанным в [методе](#previous_id) ")
@FeignClient(name = "hh-api", url = "${hh.api.base-url}", configuration = HhApiFeignConfiguration.class)
public interface VacancyConditionsApi {

    /**
     * GET /vacancy_conditions : Условия заполнения полей при добавлении и редактировании вакансий
     *
     ...
     *         or Условия заполнения полей вакансии недоступны данному пользователю (status code 403)
     */
    @Operation(
        operationId = "getVacancyConditions",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Успешный ответ", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = VacanciesVacancyConditions.class))
            }),
            @ApiResponse(responseCode = "403", description = "Условия заполнения полей вакансии недоступны данному пользователю", content = {
    ...
    @RequestMapping(
        ...
        value = "/vacancy_conditions",
        produces = { "application/json" }
    )
    
    ResponseEntity<VacanciesVacancyConditions> getVacancyConditions(
