...
import ru.brobrocode.cadra.client.model.DictionariesBranchItem;
...
public interface IndustriesApi {

    /**
     * GET /industries : Отрасли компаний
    ...
    ResponseEntity<List<DictionariesBranchItem>> getIndustries(
