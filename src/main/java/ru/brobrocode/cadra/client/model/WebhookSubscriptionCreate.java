...
public class WebhookSubscriptionCreate {
   ...
   */
  public WebhookSubscriptionCreate(List<WebhookSubscriptionCommonItemActionsInner> actions, URI url) {
    this.actions = actions;
    this.url = url;
  }

  public WebhookSubscriptionCreate actions(List<WebhookSubscriptionCommonItemActionsInner> actions) {
    this.actions = actions;
    return this;
  }

  public WebhookSubscriptionCreate addActionsItem(WebhookSubscriptionCommonItemActionsInner actionsItem) {
  ...
  */
  ...
  public WebhookSubscriptionCreate url(URI url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.actions, webhookSubscriptionCreate.actions) &&
