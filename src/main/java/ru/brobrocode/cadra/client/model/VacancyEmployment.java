...
public class VacancyEmployment {
  ...
  public VacancyEmployment id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    VacancyEmployment vacancyEmployment = (VacancyEmployment) o;
    return Objects.equals(this.id, vacancyEmployment.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class VacancyEmployment {\n");
