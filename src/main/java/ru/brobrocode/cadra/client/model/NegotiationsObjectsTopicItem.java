...
public class NegotiationsObjectsTopicItem {
  ...
  public NegotiationsObjectsTopicItem() {
    super();
  }
   ...
   */
  public NegotiationsObjectsTopicItem(String createdAt, Boolean hasUpdates, String id, String messagingStatus, IncludesIdName state, String updatedAt, Boolean viewedByOpponent, Boolean declineAllowed, Boolean hidden) {
  ...
  public NegotiationsObjectsTopicItem applicantQuestionState(Boolean applicantQuestionState) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem counters(NegotiationsObjectsCounters counters) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem createdAt(String createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem hasUpdates(Boolean hasUpdates) {
    this.hasUpdates = hasUpdates;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem messagesUrl(String messagesUrl) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem messagingStatus(String messagingStatus) {
    this.messagingStatus = messagingStatus;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem professionalRoles(List<@Valid VacancyProfessionalRoleItem> professionalRoles) {
    this.professionalRoles = professionalRoles;
    return this;
  }

  public NegotiationsObjectsTopicItem addProfessionalRolesItem(VacancyProfessionalRoleItem professionalRolesItem) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem source(SourceEnum source) {
    this.source = source;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem state(IncludesIdName state) {
    this.state = state;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem updatedAt(String updatedAt) {
    this.updatedAt = updatedAt;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem viewedByOpponent(Boolean viewedByOpponent) {
    this.viewedByOpponent = viewedByOpponent;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem declineAllowed(Boolean declineAllowed) {
    this.declineAllowed = declineAllowed;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsTopicItem jobSearchStatus(IncludesIdName jobSearchStatus) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem phoneCalls(NegotiationsPhoneCalls phoneCalls) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem tags(List<@Valid IncludesId> tags) {
    this.tags = tags;
    return this;
  }

  public NegotiationsObjectsTopicItem addTagsItem(IncludesId tagsItem) {
    if (this.tags == null) {
  ...
  */
  ...
  public NegotiationsObjectsTopicItem vacancy(VacanciesNegotiationsVacancyShort vacancy) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    NegotiationsObjectsTopicItem negotiationsObjectsTopicItem = (NegotiationsObjectsTopicItem) o;
    return Objects.equals(this.applicantQuestionState, negotiationsObjectsTopicItem.applicantQuestionState) &&
        Objects.equals(this.counters, negotiationsObjectsTopicItem.counters) &&
        Objects.equals(this.createdAt, negotiationsObjectsTopicItem.createdAt) &&
        Objects.equals(this.hasUpdates, negotiationsObjectsTopicItem.hasUpdates) &&
        Objects.equals(this.id, negotiationsObjectsTopicItem.id) &&
        Objects.equals(this.messagesUrl, negotiationsObjectsTopicItem.messagesUrl) &&
        Objects.equals(this.messagingStatus, negotiationsObjectsTopicItem.messagingStatus) &&
        Objects.equals(this.professionalRoles, negotiationsObjectsTopicItem.professionalRoles) &&
        Objects.equals(this.source, negotiationsObjectsTopicItem.source) &&
        Objects.equals(this.state, negotiationsObjectsTopicItem.state) &&
        Objects.equals(this.updatedAt, negotiationsObjectsTopicItem.updatedAt) &&
        Objects.equals(this.viewedByOpponent, negotiationsObjectsTopicItem.viewedByOpponent) &&
        Objects.equals(this.declineAllowed, negotiationsObjectsTopicItem.declineAllowed) &&
        Objects.equals(this.hidden, negotiationsObjectsTopicItem.hidden) &&
        Objects.equals(this.jobSearchStatus, negotiationsObjectsTopicItem.jobSearchStatus) &&
        Objects.equals(this.phoneCalls, negotiationsObjectsTopicItem.phoneCalls) &&
        Objects.equals(this.tags, negotiationsObjectsTopicItem.tags) &&
        Objects.equals(this.vacancy, negotiationsObjectsTopicItem.vacancy);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicantQuestionState, counters, createdAt, hasUpdates, id, messagesUrl, messagingStatus, professionalRoles, source, state, updatedAt, viewedByOpponent, declineAllowed, hidden, jobSearchStatus, phoneCalls, tags, vacancy);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NegotiationsObjectsTopicItem {\n");
