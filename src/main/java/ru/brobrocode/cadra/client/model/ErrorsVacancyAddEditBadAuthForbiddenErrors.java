...
public class ErrorsVacancyAddEditBadAuthForbiddenErrors {
  ...
  @Valid
  private List<@Valid ErrorsVacancyAddEditForbiddenError> errors = new ArrayList<>();
  ...
  public ErrorsVacancyAddEditBadAuthForbiddenErrors() {
    super();
  }
   ...
   */
  public ErrorsVacancyAddEditBadAuthForbiddenErrors(String requestId, List<@Valid ErrorsVacancyAddEditForbiddenError> errors) {
    this.requestId = requestId;
    this.errors = errors;
  }

  public ErrorsVacancyAddEditBadAuthForbiddenErrors requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  */
  ...
  public ErrorsVacancyAddEditBadAuthForbiddenErrors description(String description) {
  ...
  */
  ...
  public ErrorsVacancyAddEditBadAuthForbiddenErrors errors(List<@Valid ErrorsVacancyAddEditForbiddenError> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorsVacancyAddEditBadAuthForbiddenErrors addErrorsItem(ErrorsVacancyAddEditForbiddenError errorsItem) {
    if (this.errors == null) {
  ...
  */
  ...
  @JsonProperty("errors")
  public List<@Valid ErrorsVacancyAddEditForbiddenError> getErrors() {
    return errors;
  }

  public void setErrors(List<@Valid ErrorsVacancyAddEditForbiddenError> errors) {
    this.errors = errors;
  }

  public ErrorsVacancyAddEditBadAuthForbiddenErrors oauthError(OauthErrorEnum oauthError) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ErrorsVacancyAddEditBadAuthForbiddenErrors errorsVacancyAddEditBadAuthForbiddenErrors = (ErrorsVacancyAddEditBadAuthForbiddenErrors) o;
    return Objects.equals(this.requestId, errorsVacancyAddEditBadAuthForbiddenErrors.requestId) &&
        Objects.equals(this.description, errorsVacancyAddEditBadAuthForbiddenErrors.description) &&
        Objects.equals(this.errors, errorsVacancyAddEditBadAuthForbiddenErrors.errors) &&
        Objects.equals(this.oauthError, errorsVacancyAddEditBadAuthForbiddenErrors.oauthError);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsVacancyAddEditBadAuthForbiddenErrors {\n");
