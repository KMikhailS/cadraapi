...
public class ResumeObjectsExperiencePropertiesShort {
  ...
  public ResumeObjectsExperiencePropertiesShort area(IncludesIdNameUrl area) {
    this.area = area;
    return this;
  }
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort company(String company) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort companyId(String companyId) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort companyUrl(String companyUrl) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort employer(EmployersEmployerInfoShort employer) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort end(String end) {
    this.end = end;
    return this;
  }
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort industries(List<@Valid IncludesIdName> industries) {
    this.industries = industries;
    return this;
  }

  public ResumeObjectsExperiencePropertiesShort addIndustriesItem(IncludesIdName industriesItem) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort industry(ResumeObjectsIndustry industry) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort position(String position) {
  ...
  */
  ...
  public ResumeObjectsExperiencePropertiesShort start(String start) {
    this.start = start;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ResumeObjectsExperiencePropertiesShort resumeObjectsExperiencePropertiesShort = (ResumeObjectsExperiencePropertiesShort) o;
    return Objects.equals(this.area, resumeObjectsExperiencePropertiesShort.area) &&
        Objects.equals(this.company, resumeObjectsExperiencePropertiesShort.company) &&
        Objects.equals(this.companyId, resumeObjectsExperiencePropertiesShort.companyId) &&
        Objects.equals(this.companyUrl, resumeObjectsExperiencePropertiesShort.companyUrl) &&
        Objects.equals(this.employer, resumeObjectsExperiencePropertiesShort.employer) &&
        Objects.equals(this.end, resumeObjectsExperiencePropertiesShort.end) &&
        Objects.equals(this.industries, resumeObjectsExperiencePropertiesShort.industries) &&
        Objects.equals(this.industry, resumeObjectsExperiencePropertiesShort.industry) &&
        Objects.equals(this.position, resumeObjectsExperiencePropertiesShort.position) &&
        Objects.equals(this.start, resumeObjectsExperiencePropertiesShort.start);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumeObjectsExperiencePropertiesShort {\n");
