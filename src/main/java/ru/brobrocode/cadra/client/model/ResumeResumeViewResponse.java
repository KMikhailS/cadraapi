...
@Schema(name = "ResumeResumeViewResponse", description = "Информация о резюме")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-17T15:41:09.394389505+05:00[Asia/Yekaterinburg]", comments = "Generator version: 7.6.0")
public class ResumeResumeViewResponse {
  ...
  public ResumeResumeViewResponse() {
    super();
  }
  ...
  public ResumeResumeViewResponse alternateUrl(String alternateUrl) {
    this.alternateUrl = alternateUrl;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse employmentForm(List<@Valid ResumeObjectsEmploymentFormEmploymentFormItemResponse> employmentForm) {
    this.employmentForm = employmentForm;
    return this;
  }

  public ResumeResumeViewResponse addEmploymentFormItem(ResumeObjectsEmploymentFormEmploymentFormItemResponse employmentFormItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse workFormat(List<@Valid ResumeObjectsWorkFormatWorkFormatItemResponse> workFormat) {
    this.workFormat = workFormat;
    return this;
  }

  public ResumeResumeViewResponse addWorkFormatItem(ResumeObjectsWorkFormatWorkFormatItemResponse workFormatItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse age(BigDecimal age) {
    this.age = age;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse area(IncludesIdNameUrl area) {
    this.area = area;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse canViewFullInfo(Boolean canViewFullInfo) {
  ...
  */
  ...
  public ResumeResumeViewResponse certificate(List<@Valid ResumeObjectsCertificate> certificate) {
    this.certificate = certificate;
    return this;
  }

  public ResumeResumeViewResponse addCertificateItem(ResumeObjectsCertificate certificateItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse createdAt(String createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse download(Object download) {
    this.download = download;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse education(Object education) {
    this.education = education;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse firstName(String firstName) {
  ...
  */
  ...
  public ResumeResumeViewResponse gender(IncludesIdName gender) {
    this.gender = gender;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse hiddenFields(List<@Valid IncludesIdName> hiddenFields) {
    this.hiddenFields = hiddenFields;
    return this;
  }

  public ResumeResumeViewResponse addHiddenFieldsItem(IncludesIdName hiddenFieldsItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse lastName(String lastName) {
  ...
  */
  ...
  public ResumeResumeViewResponse marked(Boolean marked) {
    this.marked = marked;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse middleName(String middleName) {
  ...
  */
  ...
  public ResumeResumeViewResponse platform(Object platform) {
  ...
  */
  ...
  public ResumeResumeViewResponse realId(String realId) {
    this.realId = realId;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse salary(ResumeObjectsSalaryProperties salary) {
    this.salary = salary;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse totalExperience(ResumeObjectsTotalExperience totalExperience) {
  ...
  */
  ...
  public ResumeResumeViewResponse updatedAt(String updatedAt) {
    this.updatedAt = updatedAt;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse experience(List<ResumeObjectsExperience> experience) {
    this.experience = experience;
    return this;
  }

  public ResumeResumeViewResponse addExperienceItem(ResumeObjectsExperience experienceItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse birthDate(String birthDate) {
  ...
  */
  ...
  public ResumeResumeViewResponse businessTripReadiness(IncludesIdName businessTripReadiness) {
    this.businessTripReadiness = businessTripReadiness;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse citizenship(List<@Valid IncludesIdNameUrl> citizenship) {
    this.citizenship = citizenship;
    return this;
  }

  public ResumeResumeViewResponse addCitizenshipItem(IncludesIdNameUrl citizenshipItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse contact(List<IncludesContact> contact) {
    this.contact = contact;
    return this;
  }

  public ResumeResumeViewResponse addContactItem(IncludesContact contactItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse creds(CredsCreds creds) {
    this.creds = creds;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse driverLicenseTypes(List<@Valid ResumeObjectsDriverLicenseTypes> driverLicenseTypes) {
    this.driverLicenseTypes = driverLicenseTypes;
    return this;
  }

  public ResumeResumeViewResponse addDriverLicenseTypesItem(ResumeObjectsDriverLicenseTypes driverLicenseTypesItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse employment(IncludesIdName employment) {
  ...
  */
  ...
  public ResumeResumeViewResponse employments(List<@Valid IncludesIdName> employments) {
    this.employments = employments;
    return this;
  }

  public ResumeResumeViewResponse addEmploymentsItem(IncludesIdName employmentsItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse hasVehicle(Boolean hasVehicle) {
  ...
  */
  ...
  public ResumeResumeViewResponse language(List<IncludesLanguageLevel> language) {
    this.language = language;
    return this;
  }

  public ResumeResumeViewResponse addLanguageItem(IncludesLanguageLevel languageItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse metro(ResumeObjectsMetroStation metro) {
    this.metro = metro;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse paidServices(List<@Valid ResumeObjectsPaidServices> paidServices) {
    this.paidServices = paidServices;
    return this;
  }

  public ResumeResumeViewResponse addPaidServicesItem(ResumeObjectsPaidServices paidServicesItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse professionalRoles(List<@Valid IncludesIdName> professionalRoles) {
    this.professionalRoles = professionalRoles;
    return this;
  }

  public ResumeResumeViewResponse addProfessionalRolesItem(IncludesIdName professionalRolesItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse recommendation(List<@Valid ResumeObjectsRecommendation> recommendation) {
    this.recommendation = recommendation;
    return this;
  }

  public ResumeResumeViewResponse addRecommendationItem(ResumeObjectsRecommendation recommendationItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse relocation(Object relocation) {
    this.relocation = relocation;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse resumeLocale(Object resumeLocale) {
    this.resumeLocale = resumeLocale;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse schedule(IncludesIdName schedule) {
    this.schedule = schedule;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse schedules(List<@Valid IncludesIdName> schedules) {
    this.schedules = schedules;
    return this;
  }

  public ResumeResumeViewResponse addSchedulesItem(IncludesIdName schedulesItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse site(List<@Valid ResumeObjectsSite> site) {
    this.site = site;
    return this;
  }

  public ResumeResumeViewResponse addSiteItem(ResumeObjectsSite siteItem) {
    if (this.site == null) {
  ...
  */
  ...
  public ResumeResumeViewResponse skillSet(List<String> skillSet) {
    this.skillSet = skillSet;
    return this;
  }

  public ResumeResumeViewResponse addSkillSetItem(String skillSetItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse skills(String skills) {
    this.skills = skills;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse tags(List<@Valid IncludesId> tags) {
    this.tags = tags;
    return this;
  }

  public ResumeResumeViewResponse addTagsItem(IncludesId tagsItem) {
    if (this.tags == null) {
  ...
  */
  ...
  public ResumeResumeViewResponse travelTime(IncludesIdName travelTime) {
    this.travelTime = travelTime;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse workTicket(List<@Valid IncludesIdNameUrl> workTicket) {
    this.workTicket = workTicket;
    return this;
  }

  public ResumeResumeViewResponse addWorkTicketItem(IncludesIdNameUrl workTicketItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse actions(ResumeObjectsActionsForOwner actions) {
    this.actions = actions;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse contactsOpenUntilDate(String contactsOpenUntilDate) {
  ...
  */
  ...
  public ResumeResumeViewResponse favorited(Boolean favorited) {
    this.favorited = favorited;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse jobSearchStatus(IncludesIdNameLastChangeTime jobSearchStatus) {
  ...
  */
  ...
  public ResumeResumeViewResponse negotiationsHistory(ResumeObjectsNegotiationsHistoryForEmployer negotiationsHistory) {
  ...
  */
  ...
  public ResumeResumeViewResponse owner(ResumeObjectsOwner owner) {
    this.owner = owner;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse photo(ResumeObjectsPhoto photo) {
    this.photo = photo;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse portfolio(List<@Valid ResumeObjectsPortfolio> portfolio) {
    this.portfolio = portfolio;
    return this;
  }

  public ResumeResumeViewResponse addPortfolioItem(ResumeObjectsPortfolio portfolioItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse viewWithoutContactsReason(String viewWithoutContactsReason) {
  ...
  */
  ...
  public ResumeResumeViewResponse blocked(Boolean blocked) {
    this.blocked = blocked;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse canPublishOrUpdate(Boolean canPublishOrUpdate) {
  ...
  */
  ...
  public ResumeResumeViewResponse finished(Boolean finished) {
    this.finished = finished;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse status(IncludesIdName status) {
    this.status = status;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse moderationNote(List<@Valid ResumeObjectsModerationNote> moderationNote) {
    this.moderationNote = moderationNote;
    return this;
  }

  public ResumeResumeViewResponse addModerationNoteItem(ResumeObjectsModerationNote moderationNoteItem) {
  ...
  */
  ...
  public ResumeResumeViewResponse progress(ResumeObjectsProgress progress) {
    this.progress = progress;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse publishUrl(String publishUrl) {
    this.publishUrl = publishUrl;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse access(ResumeObjectsAccess access) {
    this.access = access;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse newViews(BigDecimal newViews) {
    this.newViews = newViews;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse nextPublishAt(String nextPublishAt) {
  ...
  */
  ...
  public ResumeResumeViewResponse totalViews(BigDecimal totalViews) {
    this.totalViews = totalViews;
    return this;
  }
  ...
  */
  ...
  public ResumeResumeViewResponse viewsUrl(String viewsUrl) {
    this.viewsUrl = viewsUrl;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ResumeResumeViewResponse resumeResumeViewResponse = (ResumeResumeViewResponse) o;
    return Objects.equals(this.alternateUrl, resumeResumeViewResponse.alternateUrl) &&
        Objects.equals(this.id, resumeResumeViewResponse.id) &&
        Objects.equals(this.title, resumeResumeViewResponse.title) &&
        Objects.equals(this.employmentForm, resumeResumeViewResponse.employmentForm) &&
        Objects.equals(this.workFormat, resumeResumeViewResponse.workFormat) &&
        Objects.equals(this.age, resumeResumeViewResponse.age) &&
        Objects.equals(this.area, resumeResumeViewResponse.area) &&
        Objects.equals(this.canViewFullInfo, resumeResumeViewResponse.canViewFullInfo) &&
        Objects.equals(this.certificate, resumeResumeViewResponse.certificate) &&
        Objects.equals(this.createdAt, resumeResumeViewResponse.createdAt) &&
        Objects.equals(this.download, resumeResumeViewResponse.download) &&
        Objects.equals(this.education, resumeResumeViewResponse.education) &&
        Objects.equals(this.firstName, resumeResumeViewResponse.firstName) &&
        Objects.equals(this.gender, resumeResumeViewResponse.gender) &&
        Objects.equals(this.hiddenFields, resumeResumeViewResponse.hiddenFields) &&
        Objects.equals(this.lastName, resumeResumeViewResponse.lastName) &&
        Objects.equals(this.marked, resumeResumeViewResponse.marked) &&
        Objects.equals(this.middleName, resumeResumeViewResponse.middleName) &&
        Objects.equals(this.platform, resumeResumeViewResponse.platform) &&
        Objects.equals(this.realId, resumeResumeViewResponse.realId) &&
        Objects.equals(this.salary, resumeResumeViewResponse.salary) &&
        Objects.equals(this.totalExperience, resumeResumeViewResponse.totalExperience) &&
        Objects.equals(this.updatedAt, resumeResumeViewResponse.updatedAt) &&
        Objects.equals(this.experience, resumeResumeViewResponse.experience) &&
        Objects.equals(this.birthDate, resumeResumeViewResponse.birthDate) &&
        Objects.equals(this.businessTripReadiness, resumeResumeViewResponse.businessTripReadiness) &&
        Objects.equals(this.citizenship, resumeResumeViewResponse.citizenship) &&
        Objects.equals(this.contact, resumeResumeViewResponse.contact) &&
        Objects.equals(this.creds, resumeResumeViewResponse.creds) &&
        Objects.equals(this.driverLicenseTypes, resumeResumeViewResponse.driverLicenseTypes) &&
        Objects.equals(this.employment, resumeResumeViewResponse.employment) &&
        Objects.equals(this.employments, resumeResumeViewResponse.employments) &&
        Objects.equals(this.hasVehicle, resumeResumeViewResponse.hasVehicle) &&
        Objects.equals(this.language, resumeResumeViewResponse.language) &&
        Objects.equals(this.metro, resumeResumeViewResponse.metro) &&
        Objects.equals(this.paidServices, resumeResumeViewResponse.paidServices) &&
        Objects.equals(this.professionalRoles, resumeResumeViewResponse.professionalRoles) &&
        Objects.equals(this.recommendation, resumeResumeViewResponse.recommendation) &&
        Objects.equals(this.relocation, resumeResumeViewResponse.relocation) &&
        Objects.equals(this.resumeLocale, resumeResumeViewResponse.resumeLocale) &&
        Objects.equals(this.schedule, resumeResumeViewResponse.schedule) &&
        Objects.equals(this.schedules, resumeResumeViewResponse.schedules) &&
        Objects.equals(this.site, resumeResumeViewResponse.site) &&
        Objects.equals(this.skillSet, resumeResumeViewResponse.skillSet) &&
        Objects.equals(this.skills, resumeResumeViewResponse.skills) &&
        Objects.equals(this.tags, resumeResumeViewResponse.tags) &&
        Objects.equals(this.travelTime, resumeResumeViewResponse.travelTime) &&
        Objects.equals(this.workTicket, resumeResumeViewResponse.workTicket) &&
        Objects.equals(this.actions, resumeResumeViewResponse.actions) &&
        Objects.equals(this.contactsOpenUntilDate, resumeResumeViewResponse.contactsOpenUntilDate) &&
        Objects.equals(this.favorited, resumeResumeViewResponse.favorited) &&
        Objects.equals(this.jobSearchStatus, resumeResumeViewResponse.jobSearchStatus) &&
        Objects.equals(this.negotiationsHistory, resumeResumeViewResponse.negotiationsHistory) &&
        Objects.equals(this.owner, resumeResumeViewResponse.owner) &&
        Objects.equals(this.photo, resumeResumeViewResponse.photo) &&
        Objects.equals(this.portfolio, resumeResumeViewResponse.portfolio) &&
        Objects.equals(this.viewWithoutContactsReason, resumeResumeViewResponse.viewWithoutContactsReason) &&
        Objects.equals(this.blocked, resumeResumeViewResponse.blocked) &&
        Objects.equals(this.canPublishOrUpdate, resumeResumeViewResponse.canPublishOrUpdate) &&
        Objects.equals(this.finished, resumeResumeViewResponse.finished) &&
        Objects.equals(this.status, resumeResumeViewResponse.status) &&
        Objects.equals(this.moderationNote, resumeResumeViewResponse.moderationNote) &&
        Objects.equals(this.progress, resumeResumeViewResponse.progress) &&
        Objects.equals(this.publishUrl, resumeResumeViewResponse.publishUrl) &&
        Objects.equals(this.access, resumeResumeViewResponse.access) &&
        Objects.equals(this.newViews, resumeResumeViewResponse.newViews) &&
        Objects.equals(this.nextPublishAt, resumeResumeViewResponse.nextPublishAt) &&
        Objects.equals(this.totalViews, resumeResumeViewResponse.totalViews) &&
        Objects.equals(this.viewsUrl, resumeResumeViewResponse.viewsUrl);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alternateUrl, id, title, employmentForm, workFormat, age, area, canViewFullInfo, certificate, createdAt, download, education, firstName, gender, hiddenFields, lastName, marked, middleName, platform, realId, salary, totalExperience, updatedAt, experience, birthDate, businessTripReadiness, citizenship, contact, creds, driverLicenseTypes, employment, employments, hasVehicle, language, metro, paidServices, professionalRoles, recommendation, relocation, resumeLocale, schedule, schedules, site, skillSet, skills, tags, travelTime, workTicket, actions, contactsOpenUntilDate, favorited, jobSearchStatus, negotiationsHistory, owner, photo, portfolio, viewWithoutContactsReason, blocked, canPublishOrUpdate, finished, status, moderationNote, progress, publishUrl, access, newViews, nextPublishAt, totalViews, viewsUrl);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ResumeResumeViewResponse {\n");
