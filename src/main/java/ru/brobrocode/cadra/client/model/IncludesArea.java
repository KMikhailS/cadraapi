...
@JsonTypeName("_IncludesArea")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-17T15:41:09.394389505+05:00[Asia/Yekaterinburg]", comments = "Generator version: 7.6.0")
public class IncludesArea {
   ...
   */
  public IncludesArea(String id, String name, String url) {
    this.id = id;
    this.name = name;
    this.url = url;
  }

  public IncludesArea id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public IncludesArea name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public IncludesArea url(String url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    IncludesArea includesArea = (IncludesArea) o;
    return Objects.equals(this.id, includesArea.id) &&
        Objects.equals(this.name, includesArea.name) &&
        Objects.equals(this.url, includesArea.url);
  }
