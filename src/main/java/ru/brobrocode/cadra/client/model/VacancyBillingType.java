...
public class VacancyBillingType {
   ...
   */
  public VacancyBillingType(String id) {
    this.id = id;
  }

  public VacancyBillingType id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    VacancyBillingType vacancyBillingType = (VacancyBillingType) o;
    return Objects.equals(this.id, vacancyBillingType.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class VacancyBillingType {\n");
