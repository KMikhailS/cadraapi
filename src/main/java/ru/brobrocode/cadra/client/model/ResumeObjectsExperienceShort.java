...
public class ResumeObjectsExperienceShort {
  ...
  public ResumeObjectsExperienceShort() {
    super();
  }
   ...
   */
  public ResumeObjectsExperienceShort(List<@Valid IncludesIdName> industries, String position, String start) {
    this.industries = industries;
    this.position = position;
    this.start = start;
  }

  public ResumeObjectsExperienceShort area(IncludesIdNameUrl area) {
    this.area = area;
    return this;
  }
  ...
  */
  ...
  public ResumeObjectsExperienceShort company(String company) {
  ...
  */
  ...
  public ResumeObjectsExperienceShort companyId(String companyId) {
  ...
  */
  ...
  public ResumeObjectsExperienceShort companyUrl(String companyUrl) {
  ...
  */
  ...
  public ResumeObjectsExperienceShort employer(EmployersEmployerInfoShort employer) {
  ...
  */
  ...
  public ResumeObjectsExperienceShort end(String end) {
    this.end = end;
    return this;
  }
  ...
  */
  ...
  public ResumeObjectsExperienceShort industries(List<@Valid IncludesIdName> industries) {
    this.industries = industries;
    return this;
  }

  public ResumeObjectsExperienceShort addIndustriesItem(IncludesIdName industriesItem) {
  ...
  */
  ...
  public ResumeObjectsExperienceShort industry(ResumeObjectsIndustry industry) {
  ...
  */
  ...
  public ResumeObjectsExperienceShort position(String position) {
    this.position = position;
    return this;
  }
  ...
  */
  ...
  public ResumeObjectsExperienceShort start(String start) {
    this.start = start;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ResumeObjectsExperienceShort resumeObjectsExperienceShort = (ResumeObjectsExperienceShort) o;
    return Objects.equals(this.area, resumeObjectsExperienceShort.area) &&
        Objects.equals(this.company, resumeObjectsExperienceShort.company) &&
        Objects.equals(this.companyId, resumeObjectsExperienceShort.companyId) &&
        Objects.equals(this.companyUrl, resumeObjectsExperienceShort.companyUrl) &&
        Objects.equals(this.employer, resumeObjectsExperienceShort.employer) &&
        Objects.equals(this.end, resumeObjectsExperienceShort.end) &&
        Objects.equals(this.industries, resumeObjectsExperienceShort.industries) &&
        Objects.equals(this.industry, resumeObjectsExperienceShort.industry) &&
        Objects.equals(this.position, resumeObjectsExperienceShort.position) &&
        Objects.equals(this.start, resumeObjectsExperienceShort.start);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumeObjectsExperienceShort {\n");
