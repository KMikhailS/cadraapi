...
@Schema(name = "ResumeAddResumeRequest", description = "Тело запроса при создании резюме")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-17T15:41:09.394389505+05:00[Asia/Yekaterinburg]", comments = "Generator version: 7.6.0")
public class ResumeAddResumeRequest {
  ...
  @Valid
  private List<ResumeObjectsContact> contact = new ArrayList<>();

  private Object education;

  @Valid
  private List<ResumeObjectsExperienceCreateEditResume> experience = new ArrayList<>();

  private Id gender;

  @Valid
  private List<ResumeObjectsLanguage> language = new ArrayList<>();

  public ResumeAddResumeRequest access(ResumeObjectsAccess access) {
    this.access = access;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest birthDate(String birthDate) {
  ...
  */
  ...
  public ResumeAddResumeRequest businessTripReadiness(IncludesId businessTripReadiness) {
  ...
  */
  ...
  public ResumeAddResumeRequest certificate(List<@Valid ResumeObjectsCertificate> certificate) {
    this.certificate = certificate;
    return this;
  }

  public ResumeAddResumeRequest addCertificateItem(ResumeObjectsCertificate certificateItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest driverLicenseTypes(List<@Valid ResumeObjectsDriverLicenseTypes> driverLicenseTypes) {
    this.driverLicenseTypes = driverLicenseTypes;
    return this;
  }

  public ResumeAddResumeRequest addDriverLicenseTypesItem(ResumeObjectsDriverLicenseTypes driverLicenseTypesItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest employmentForm(List<@Valid ResumeObjectsEmploymentFormEmploymentFormItem> employmentForm) {
    this.employmentForm = employmentForm;
    return this;
  }

  public ResumeAddResumeRequest addEmploymentFormItem(ResumeObjectsEmploymentFormEmploymentFormItem employmentFormItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest employments(List<@Valid IncludesIdName> employments) {
    this.employments = employments;
    return this;
  }

  public ResumeAddResumeRequest addEmploymentsItem(IncludesIdName employmentsItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest firstName(String firstName) {
  ...
  */
  ...
  public ResumeAddResumeRequest hasVehicle(Boolean hasVehicle) {
  ...
  */
  ...
  public ResumeAddResumeRequest hiddenFields(List<@Valid IncludesIdName> hiddenFields) {
    this.hiddenFields = hiddenFields;
    return this;
  }

  public ResumeAddResumeRequest addHiddenFieldsItem(IncludesIdName hiddenFieldsItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest lastName(String lastName) {
  ...
  */
  ...
  public ResumeAddResumeRequest metro(IncludesId metro) {
    this.metro = metro;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest middleName(String middleName) {
  ...
  */
  ...
  public ResumeAddResumeRequest photo(ResumeObjectsPhoto photo) {
    this.photo = photo;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest portfolio(List<@Valid ResumeObjectsPortfolio> portfolio) {
    this.portfolio = portfolio;
    return this;
  }

  public ResumeAddResumeRequest addPortfolioItem(ResumeObjectsPortfolio portfolioItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest professionalRoles(List<@Valid IncludesId> professionalRoles) {
    this.professionalRoles = professionalRoles;
    return this;
  }

  public ResumeAddResumeRequest addProfessionalRolesItem(IncludesId professionalRolesItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest recommendation(List<@Valid ResumeObjectsRecommendation> recommendation) {
    this.recommendation = recommendation;
    return this;
  }

  public ResumeAddResumeRequest addRecommendationItem(ResumeObjectsRecommendation recommendationItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest relocation(ResumeObjectsRelocationPublic relocation) {
  ...
  */
  ...
  public ResumeAddResumeRequest resumeLocale(IncludesIdName resumeLocale) {
  ...
  */
  ...
  public ResumeAddResumeRequest salary(ResumeObjectsSalaryAddEdit salary) {
    this.salary = salary;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest schedules(List<@Valid IncludesIdName> schedules) {
    this.schedules = schedules;
    return this;
  }

  public ResumeAddResumeRequest addSchedulesItem(IncludesIdName schedulesItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest site(List<@Valid ResumeObjectsSite> site) {
    this.site = site;
    return this;
  }

  public ResumeAddResumeRequest addSiteItem(ResumeObjectsSite siteItem) {
    if (this.site == null) {
  ...
  */
  ...
  public ResumeAddResumeRequest skillSet(List<String> skillSet) {
    this.skillSet = skillSet;
    return this;
  }

  public ResumeAddResumeRequest addSkillSetItem(String skillSetItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest skills(String skills) {
    this.skills = skills;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest title(String title) {
    this.title = title;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest totalExperience(ResumeObjectsTotalExperience totalExperience) {
  ...
  */
  ...
  public ResumeAddResumeRequest travelTime(IncludesId travelTime) {
  ...
  */
  ...
  public ResumeAddResumeRequest workFormat(List<@Valid ResumeObjectsWorkFormatWorkFormatItem> workFormat) {
    this.workFormat = workFormat;
    return this;
  }

  public ResumeAddResumeRequest addWorkFormatItem(ResumeObjectsWorkFormatWorkFormatItem workFormatItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest workTicket(List<@Valid IncludesId> workTicket) {
    this.workTicket = workTicket;
    return this;
  }

  public ResumeAddResumeRequest addWorkTicketItem(IncludesId workTicketItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest area(Id area) {
    this.area = area;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest citizenship(List<@Valid IncludesId> citizenship) {
    this.citizenship = citizenship;
    return this;
  }

  public ResumeAddResumeRequest addCitizenshipItem(IncludesId citizenshipItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest contact(List<ResumeObjectsContact> contact) {
    this.contact = contact;
    return this;
  }

  public ResumeAddResumeRequest addContactItem(ResumeObjectsContact contactItem) {
  ...
  */
  ...
  public ResumeAddResumeRequest education(Object education) {
  ...
  */
  ...
  public ResumeAddResumeRequest experience(List<ResumeObjectsExperienceCreateEditResume> experience) {
    this.experience = experience;
    return this;
  }

  public ResumeAddResumeRequest addExperienceItem(ResumeObjectsExperienceCreateEditResume experienceItem) {
  ...
  */
  ...
  public List<ResumeObjectsExperienceCreateEditResume> getExperience() {
    return experience;
  }

  public void setExperience(List<ResumeObjectsExperienceCreateEditResume> experience) {
    this.experience = experience;
  }

  public ResumeAddResumeRequest gender(Id gender) {
    this.gender = gender;
    return this;
  }
  ...
  */
  ...
  public ResumeAddResumeRequest language(List<ResumeObjectsLanguage> language) {
    this.language = language;
    return this;
  }

  public ResumeAddResumeRequest addLanguageItem(ResumeObjectsLanguage languageItem) {
  ...
  */
  ...
  public List<ResumeObjectsLanguage> getLanguage() {
    return language;
  }

  public void setLanguage(List<ResumeObjectsLanguage> language) {
    this.language = language;
  }
  ...
  public boolean equals(Object o) {
    ...
    ResumeAddResumeRequest resumeAddResumeRequest = (ResumeAddResumeRequest) o;
    return Objects.equals(this.access, resumeAddResumeRequest.access) &&
        Objects.equals(this.birthDate, resumeAddResumeRequest.birthDate) &&
        Objects.equals(this.businessTripReadiness, resumeAddResumeRequest.businessTripReadiness) &&
        Objects.equals(this.certificate, resumeAddResumeRequest.certificate) &&
        Objects.equals(this.driverLicenseTypes, resumeAddResumeRequest.driverLicenseTypes) &&
        Objects.equals(this.employmentForm, resumeAddResumeRequest.employmentForm) &&
        Objects.equals(this.employments, resumeAddResumeRequest.employments) &&
        Objects.equals(this.firstName, resumeAddResumeRequest.firstName) &&
        Objects.equals(this.hasVehicle, resumeAddResumeRequest.hasVehicle) &&
        Objects.equals(this.hiddenFields, resumeAddResumeRequest.hiddenFields) &&
        Objects.equals(this.lastName, resumeAddResumeRequest.lastName) &&
        Objects.equals(this.metro, resumeAddResumeRequest.metro) &&
        Objects.equals(this.middleName, resumeAddResumeRequest.middleName) &&
        Objects.equals(this.photo, resumeAddResumeRequest.photo) &&
        Objects.equals(this.portfolio, resumeAddResumeRequest.portfolio) &&
        Objects.equals(this.professionalRoles, resumeAddResumeRequest.professionalRoles) &&
        Objects.equals(this.recommendation, resumeAddResumeRequest.recommendation) &&
        Objects.equals(this.relocation, resumeAddResumeRequest.relocation) &&
        Objects.equals(this.resumeLocale, resumeAddResumeRequest.resumeLocale) &&
        Objects.equals(this.salary, resumeAddResumeRequest.salary) &&
        Objects.equals(this.schedules, resumeAddResumeRequest.schedules) &&
        Objects.equals(this.site, resumeAddResumeRequest.site) &&
        Objects.equals(this.skillSet, resumeAddResumeRequest.skillSet) &&
        Objects.equals(this.skills, resumeAddResumeRequest.skills) &&
        Objects.equals(this.title, resumeAddResumeRequest.title) &&
        Objects.equals(this.totalExperience, resumeAddResumeRequest.totalExperience) &&
        Objects.equals(this.travelTime, resumeAddResumeRequest.travelTime) &&
        Objects.equals(this.workFormat, resumeAddResumeRequest.workFormat) &&
        Objects.equals(this.workTicket, resumeAddResumeRequest.workTicket) &&
        Objects.equals(this.area, resumeAddResumeRequest.area) &&
        Objects.equals(this.citizenship, resumeAddResumeRequest.citizenship) &&
        Objects.equals(this.contact, resumeAddResumeRequest.contact) &&
        Objects.equals(this.education, resumeAddResumeRequest.education) &&
        Objects.equals(this.experience, resumeAddResumeRequest.experience) &&
        Objects.equals(this.gender, resumeAddResumeRequest.gender) &&
        Objects.equals(this.language, resumeAddResumeRequest.language);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumeAddResumeRequest {\n");
