...
public class ErrorsNegotiationHideResponseForbiddenErrors {
  ...
  public ErrorsNegotiationHideResponseForbiddenErrors() {
    super();
  }
   ...
   */
  public ErrorsNegotiationHideResponseForbiddenErrors(String requestId, List<@Valid ErrorsNegotiationHideResponseError> errors) {
    this.requestId = requestId;
    this.errors = errors;
  }

  public ErrorsNegotiationHideResponseForbiddenErrors requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  */
  ...
  public ErrorsNegotiationHideResponseForbiddenErrors description(String description) {
  ...
  */
  ...
  public ErrorsNegotiationHideResponseForbiddenErrors errors(List<@Valid ErrorsNegotiationHideResponseError> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorsNegotiationHideResponseForbiddenErrors addErrorsItem(ErrorsNegotiationHideResponseError errorsItem) {
    if (this.errors == null) {
  ...
  */
  ...
  public ErrorsNegotiationHideResponseForbiddenErrors oauthError(OauthErrorEnum oauthError) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ErrorsNegotiationHideResponseForbiddenErrors errorsNegotiationHideResponseForbiddenErrors = (ErrorsNegotiationHideResponseForbiddenErrors) o;
    return Objects.equals(this.requestId, errorsNegotiationHideResponseForbiddenErrors.requestId) &&
        Objects.equals(this.description, errorsNegotiationHideResponseForbiddenErrors.description) &&
        Objects.equals(this.errors, errorsNegotiationHideResponseForbiddenErrors.errors) &&
        Objects.equals(this.oauthError, errorsNegotiationHideResponseForbiddenErrors.oauthError);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsNegotiationHideResponseForbiddenErrors {\n");
