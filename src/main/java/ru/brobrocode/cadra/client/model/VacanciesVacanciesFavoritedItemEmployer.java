...
/**
 * VacanciesVacanciesFavoritedItemEmployer
 */

@JsonTypeName("VacanciesVacanciesFavoritedItem_employer")
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2025-08-17T15:41:09.394389505+05:00[Asia/Yekaterinburg]", comments = "Generator version: 7.6.0")
public class VacanciesVacanciesFavoritedItemEmployer {
  ...
  public VacanciesVacanciesFavoritedItemEmployer() {
    super();
  }
   ...
   */
  public VacanciesVacanciesFavoritedItemEmployer(String name, Boolean trusted) {
    this.name = name;
    this.trusted = trusted;
  }

  public VacanciesVacanciesFavoritedItemEmployer accreditedItEmployer(Boolean accreditedItEmployer) {
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer alternateUrl(String alternateUrl) {
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer employerRating(VacanciesEmployerRating employerRating) {
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer logoUrls(IncludesLogoUrls logoUrls) {
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer trusted(Boolean trusted) {
    this.trusted = trusted;
    return this;
  }
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer url(String url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public VacanciesVacanciesFavoritedItemEmployer vacanciesUrl(String vacanciesUrl) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    VacanciesVacanciesFavoritedItemEmployer vacanciesVacanciesFavoritedItemEmployer = (VacanciesVacanciesFavoritedItemEmployer) o;
    return Objects.equals(this.accreditedItEmployer, vacanciesVacanciesFavoritedItemEmployer.accreditedItEmployer) &&
        Objects.equals(this.alternateUrl, vacanciesVacanciesFavoritedItemEmployer.alternateUrl) &&
        Objects.equals(this.employerRating, vacanciesVacanciesFavoritedItemEmployer.employerRating) &&
        Objects.equals(this.id, vacanciesVacanciesFavoritedItemEmployer.id) &&
        Objects.equals(this.logoUrls, vacanciesVacanciesFavoritedItemEmployer.logoUrls) &&
        Objects.equals(this.name, vacanciesVacanciesFavoritedItemEmployer.name) &&
        Objects.equals(this.trusted, vacanciesVacanciesFavoritedItemEmployer.trusted) &&
        Objects.equals(this.url, vacanciesVacanciesFavoritedItemEmployer.url) &&
        Objects.equals(this.vacanciesUrl, vacanciesVacanciesFavoritedItemEmployer.vacanciesUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class VacanciesVacanciesFavoritedItemEmployer {\n");
