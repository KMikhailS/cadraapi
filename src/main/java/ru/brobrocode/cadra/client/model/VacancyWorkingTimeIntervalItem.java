...
public class VacancyWorkingTimeIntervalItem {

  private String id;

  public VacancyWorkingTimeIntervalItem id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    VacancyWorkingTimeIntervalItem vacancyWorkingTimeIntervalItem = (VacancyWorkingTimeIntervalItem) o;
    return Objects.equals(this.id, vacancyWorkingTimeIntervalItem.id);
  }
  ...
  public String toString() {
    ...
    sb.append("class VacancyWorkingTimeIntervalItem {\n");
