...
public class ErrorsResumeBadArgTooManyResumesErrors implements CreateResume400Response {
  ...
  public ErrorsResumeBadArgTooManyResumesErrors() {
    super();
  }
   ...
   */
  public ErrorsResumeBadArgTooManyResumesErrors(String requestId, List<@Valid ErrorsResumeTooManyResumesError> errors) {
    this.requestId = requestId;
    this.errors = errors;
  }

  public ErrorsResumeBadArgTooManyResumesErrors requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  */
  ...
  public ErrorsResumeBadArgTooManyResumesErrors badArgument(String badArgument) {
  ...
  */
  ...
  public ErrorsResumeBadArgTooManyResumesErrors badArguments(List<@Valid ErrorsCommonBadJsonDataErrorsAllOfBadArguments> badArguments) {
    this.badArguments = badArguments;
    return this;
  }

  public ErrorsResumeBadArgTooManyResumesErrors addBadArgumentsItem(ErrorsCommonBadJsonDataErrorsAllOfBadArguments badArgumentsItem) {
  ...
  */
  ...
  public ErrorsResumeBadArgTooManyResumesErrors description(String description) {
  ...
  */
  ...
  public ErrorsResumeBadArgTooManyResumesErrors errors(List<@Valid ErrorsResumeTooManyResumesError> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorsResumeBadArgTooManyResumesErrors addErrorsItem(ErrorsResumeTooManyResumesError errorsItem) {
    if (this.errors == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ErrorsResumeBadArgTooManyResumesErrors errorsResumeBadArgTooManyResumesErrors = (ErrorsResumeBadArgTooManyResumesErrors) o;
    return Objects.equals(this.requestId, errorsResumeBadArgTooManyResumesErrors.requestId) &&
        Objects.equals(this.badArgument, errorsResumeBadArgTooManyResumesErrors.badArgument) &&
        Objects.equals(this.badArguments, errorsResumeBadArgTooManyResumesErrors.badArguments) &&
        Objects.equals(this.description, errorsResumeBadArgTooManyResumesErrors.description) &&
        Objects.equals(this.errors, errorsResumeBadArgTooManyResumesErrors.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsResumeBadArgTooManyResumesErrors {\n");
