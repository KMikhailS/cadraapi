...
public class NegotiationsObjectsStates {
  ...
  public NegotiationsObjectsStates() {
    super();
  }
   ...
   */
  public NegotiationsObjectsStates(String description, String id, String name, String url) {
  ...
  public NegotiationsObjectsStates description(String description) {
    this.description = description;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsStates hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsStates id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsStates name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public NegotiationsObjectsStates subCollections(List<@Valid NegotiationsNegotiationsSubCollection> subCollections) {
    this.subCollections = subCollections;
    return this;
  }

  public NegotiationsObjectsStates addSubCollectionsItem(NegotiationsNegotiationsSubCollection subCollectionsItem) {
  ...
  */
  ...
  public NegotiationsObjectsStates url(String url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    NegotiationsObjectsStates negotiationsObjectsStates = (NegotiationsObjectsStates) o;
    return Objects.equals(this.description, negotiationsObjectsStates.description) &&
        Objects.equals(this.hidden, negotiationsObjectsStates.hidden) &&
        Objects.equals(this.id, negotiationsObjectsStates.id) &&
        Objects.equals(this.name, negotiationsObjectsStates.name) &&
        Objects.equals(this.subCollections, negotiationsObjectsStates.subCollections) &&
        Objects.equals(this.url, negotiationsObjectsStates.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, hidden, id, name, subCollections, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NegotiationsObjectsStates {\n");
