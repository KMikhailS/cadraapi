...
public class ErrorsVacancyFavoritedCombinedBadAuthErrors {
  ...
  @Valid
  private List<@Valid ErrorsVacancyFavoritedBadAuthError> errors = new ArrayList<>();
  ...
  public ErrorsVacancyFavoritedCombinedBadAuthErrors() {
    super();
  }
   ...
   */
  public ErrorsVacancyFavoritedCombinedBadAuthErrors(String requestId, List<@Valid ErrorsVacancyFavoritedBadAuthError> errors) {
    this.requestId = requestId;
    this.errors = errors;
  }

  public ErrorsVacancyFavoritedCombinedBadAuthErrors requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  */
  ...
  public ErrorsVacancyFavoritedCombinedBadAuthErrors description(String description) {
  ...
  */
  ...
  public ErrorsVacancyFavoritedCombinedBadAuthErrors errors(List<@Valid ErrorsVacancyFavoritedBadAuthError> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorsVacancyFavoritedCombinedBadAuthErrors addErrorsItem(ErrorsVacancyFavoritedBadAuthError errorsItem) {
    if (this.errors == null) {
  ...
  */
  ...
  @JsonProperty("errors")
  public List<@Valid ErrorsVacancyFavoritedBadAuthError> getErrors() {
    return errors;
  }

  public void setErrors(List<@Valid ErrorsVacancyFavoritedBadAuthError> errors) {
    this.errors = errors;
  }

  public ErrorsVacancyFavoritedCombinedBadAuthErrors oauthError(OauthErrorEnum oauthError) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ErrorsVacancyFavoritedCombinedBadAuthErrors errorsVacancyFavoritedCombinedBadAuthErrors = (ErrorsVacancyFavoritedCombinedBadAuthErrors) o;
    return Objects.equals(this.requestId, errorsVacancyFavoritedCombinedBadAuthErrors.requestId) &&
        Objects.equals(this.description, errorsVacancyFavoritedCombinedBadAuthErrors.description) &&
        Objects.equals(this.errors, errorsVacancyFavoritedCombinedBadAuthErrors.errors) &&
        Objects.equals(this.oauthError, errorsVacancyFavoritedCombinedBadAuthErrors.oauthError);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsVacancyFavoritedCombinedBadAuthErrors {\n");
