...
public class ErrorsResumeBadArgumentResumeErrors implements EditResume400Response {
  ...
  public ErrorsResumeBadArgumentResumeErrors() {
    super();
  }
   ...
   */
  public ErrorsResumeBadArgumentResumeErrors(String requestId, List<@Valid ErrorsResumeAddEditError> errors) {
    this.requestId = requestId;
    this.errors = errors;
  }

  public ErrorsResumeBadArgumentResumeErrors requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  */
  ...
  public ErrorsResumeBadArgumentResumeErrors badArgument(String badArgument) {
  ...
  */
  ...
  public ErrorsResumeBadArgumentResumeErrors badArguments(List<@Valid ErrorsCommonBadJsonDataErrorsAllOfBadArguments> badArguments) {
    this.badArguments = badArguments;
    return this;
  }

  public ErrorsResumeBadArgumentResumeErrors addBadArgumentsItem(ErrorsCommonBadJsonDataErrorsAllOfBadArguments badArgumentsItem) {
  ...
  */
  ...
  public ErrorsResumeBadArgumentResumeErrors description(String description) {
  ...
  */
  ...
  public ErrorsResumeBadArgumentResumeErrors errors(List<@Valid ErrorsResumeAddEditError> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorsResumeBadArgumentResumeErrors addErrorsItem(ErrorsResumeAddEditError errorsItem) {
    if (this.errors == null) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ErrorsResumeBadArgumentResumeErrors errorsResumeBadArgumentResumeErrors = (ErrorsResumeBadArgumentResumeErrors) o;
    return Objects.equals(this.requestId, errorsResumeBadArgumentResumeErrors.requestId) &&
        Objects.equals(this.badArgument, errorsResumeBadArgumentResumeErrors.badArgument) &&
        Objects.equals(this.badArguments, errorsResumeBadArgumentResumeErrors.badArguments) &&
        Objects.equals(this.description, errorsResumeBadArgumentResumeErrors.description) &&
        Objects.equals(this.errors, errorsResumeBadArgumentResumeErrors.errors);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsResumeBadArgumentResumeErrors {\n");
