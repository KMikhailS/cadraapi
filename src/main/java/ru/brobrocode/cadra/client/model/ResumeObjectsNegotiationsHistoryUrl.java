...
public class ResumeObjectsNegotiationsHistoryUrl {

  private String url;

  public ResumeObjectsNegotiationsHistoryUrl() {
    super();
  }
   ...
   */
  public ResumeObjectsNegotiationsHistoryUrl(String url) {
    this.url = url;
  }

  public ResumeObjectsNegotiationsHistoryUrl url(String url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ResumeObjectsNegotiationsHistoryUrl resumeObjectsNegotiationsHistoryUrl = (ResumeObjectsNegotiationsHistoryUrl) o;
    return Objects.equals(this.url, resumeObjectsNegotiationsHistoryUrl.url);
  }
  ...
  public String toString() {
    ...
    sb.append("class ResumeObjectsNegotiationsHistoryUrl {\n");
