...
public class EmployersEmployerItemShort {
  ...
  public EmployersEmployerItemShort() {
    super();
  }
   ...
   */
  public EmployersEmployerItemShort(String alternateUrl, String id, String name, String url, String vacanciesUrl) {
  ...
  public EmployersEmployerItemShort alternateUrl(String alternateUrl) {
    this.alternateUrl = alternateUrl;
    return this;
  }
  ...
  */
  ...
  public EmployersEmployerItemShort id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public EmployersEmployerItemShort logoUrls(IncludesLogoUrls logoUrls) {
  ...
  */
  ...
  public EmployersEmployerItemShort name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public EmployersEmployerItemShort url(String url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public EmployersEmployerItemShort vacanciesUrl(String vacanciesUrl) {
    this.vacanciesUrl = vacanciesUrl;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    EmployersEmployerItemShort employersEmployerItemShort = (EmployersEmployerItemShort) o;
    return Objects.equals(this.alternateUrl, employersEmployerItemShort.alternateUrl) &&
        Objects.equals(this.id, employersEmployerItemShort.id) &&
        Objects.equals(this.logoUrls, employersEmployerItemShort.logoUrls) &&
        Objects.equals(this.name, employersEmployerItemShort.name) &&
        Objects.equals(this.url, employersEmployerItemShort.url) &&
        Objects.equals(this.vacanciesUrl, employersEmployerItemShort.vacanciesUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class EmployersEmployerItemShort {\n");
