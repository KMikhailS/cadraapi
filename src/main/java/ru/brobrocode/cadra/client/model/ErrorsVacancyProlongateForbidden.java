...
public class ErrorsVacancyProlongateForbidden {
  ...
  @Valid
  private List<@Valid ErrorsVacancyProlongateError> errors = new ArrayList<>();
  ...
  public ErrorsVacancyProlongateForbidden() {
    super();
  }
   ...
   */
  public ErrorsVacancyProlongateForbidden(String requestId, List<@Valid ErrorsVacancyProlongateError> errors) {
    this.requestId = requestId;
    this.errors = errors;
  }

  public ErrorsVacancyProlongateForbidden requestId(String requestId) {
    this.requestId = requestId;
    return this;
  }
  ...
  */
  ...
  public ErrorsVacancyProlongateForbidden description(String description) {
  ...
  */
  ...
  public ErrorsVacancyProlongateForbidden errors(List<@Valid ErrorsVacancyProlongateError> errors) {
    this.errors = errors;
    return this;
  }

  public ErrorsVacancyProlongateForbidden addErrorsItem(ErrorsVacancyProlongateError errorsItem) {
    if (this.errors == null) {
  ...
  */
  ...
  @JsonProperty("errors")
  public List<@Valid ErrorsVacancyProlongateError> getErrors() {
    return errors;
  }

  public void setErrors(List<@Valid ErrorsVacancyProlongateError> errors) {
    this.errors = errors;
  }

  public ErrorsVacancyProlongateForbidden oauthError(OauthErrorEnum oauthError) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    ErrorsVacancyProlongateForbidden errorsVacancyProlongateForbidden = (ErrorsVacancyProlongateForbidden) o;
    return Objects.equals(this.requestId, errorsVacancyProlongateForbidden.requestId) &&
        Objects.equals(this.description, errorsVacancyProlongateForbidden.description) &&
        Objects.equals(this.errors, errorsVacancyProlongateForbidden.errors) &&
        Objects.equals(this.oauthError, errorsVacancyProlongateForbidden.oauthError);
  }
  ...
  public String toString() {
    ...
    sb.append("class ErrorsVacancyProlongateForbidden {\n");
