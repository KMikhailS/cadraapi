...
public class VacancyEditCommon {
  ...
  public VacancyEditCommon acceptHandicapped(Boolean acceptHandicapped) {
  ...
  */
  ...
  public VacancyEditCommon acceptIncompleteResumes(Boolean acceptIncompleteResumes) {
  ...
  */
  ...
  public VacancyEditCommon acceptKids(Boolean acceptKids) {
  ...
  */
  ...
  public VacancyEditCommon acceptTemporary(Boolean acceptTemporary) {
  ...
  */
  ...
  public VacancyEditCommon address(VacancyAddress address) {
  ...
  */
  ...
  public VacancyEditCommon ageRestriction(VacancyAgeRestriction ageRestriction) {
  ...
  */
  ...
  public VacancyEditCommon allowMessages(Boolean allowMessages) {
  ...
  */
  ...
  public VacancyEditCommon brandedTemplate(VacancyBrandedTemplate brandedTemplate) {
  ...
  */
  ...
  public VacancyEditCommon code(String code) {
    this.code = code;
    return this;
  }
  ...
  */
  ...
  public VacancyEditCommon contacts(VacancyContacts contacts) {
  ...
  */
  ...
  public VacancyEditCommon customEmployerName(String customEmployerName) {
  ...
  */
  ...
  public VacancyEditCommon department(VacancyDepartment department) {
  ...
  */
  ...
  public VacancyEditCommon driverLicenseTypes(List<@Valid VacancyDriverLicenceTypeItem> driverLicenseTypes) {
    this.driverLicenseTypes = driverLicenseTypes;
    return this;
  }

  public VacancyEditCommon addDriverLicenseTypesItem(VacancyDriverLicenceTypeItem driverLicenseTypesItem) {
  ...
  */
  ...
  public VacancyEditCommon employment(VacancyEmployment employment) {
  ...
  */
  ...
  public VacancyEditCommon employmentForm(VacancyEmploymentForm employmentForm) {
  ...
  */
  ...
  public VacancyEditCommon experience(VacancyExperience experience) {
  ...
  */
  ...
  public VacancyEditCommon flyInFlyOutDuration(List<@Valid VacancyFlyInFlyOutDurationFlyInFlyOutDurationItem> flyInFlyOutDuration) {
    this.flyInFlyOutDuration = flyInFlyOutDuration;
    return this;
  }

  public VacancyEditCommon addFlyInFlyOutDurationItem(VacancyFlyInFlyOutDurationFlyInFlyOutDurationItem flyInFlyOutDurationItem) {
  ...
  */
  ...
  public VacancyEditCommon internship(Boolean internship) {
  ...
  */
  ...
  public VacancyEditCommon keySkills(List<@Valid VacancyKeySkillItem> keySkills) {
    this.keySkills = keySkills;
    return this;
  }

  public VacancyEditCommon addKeySkillsItem(VacancyKeySkillItem keySkillsItem) {
  ...
  */
  ...
  public VacancyEditCommon languages(List<@Valid VacancyLanguage> languages) {
    this.languages = languages;
    return this;
  }

  public VacancyEditCommon addLanguagesItem(VacancyLanguage languagesItem) {
  ...
  */
  ...
  public VacancyEditCommon nightShifts(Boolean nightShifts) {
  ...
  */
  ...
  public VacancyEditCommon professionalRoles(List<@Valid VacancyProfessionalRoleItem> professionalRoles) {
    this.professionalRoles = professionalRoles;
    return this;
  }

  public VacancyEditCommon addProfessionalRolesItem(VacancyProfessionalRoleItem professionalRolesItem) {
  ...
  */
  ...
  public VacancyEditCommon responseLetterRequired(Boolean responseLetterRequired) {
  ...
  */
  ...
  public VacancyEditCommon responseNotifications(Boolean responseNotifications) {
  ...
  */
  ...
  public VacancyEditCommon responseUrl(String responseUrl) {
  ...
  */
  ...
  public VacancyEditCommon salary(VacancySalary salary) {
    this.salary = salary;
    return this;
  }
  ...
  */
  ...
  public VacancyEditCommon salaryRange(VacancySalaryRangeSalaryRange salaryRange) {
  ...
  */
  ...
  public VacancyEditCommon schedule(VacancySchedule schedule) {
  ...
  */
  ...
  public VacancyEditCommon showContacts(Boolean showContacts) {
  ...
  */
  ...
  public VacancyEditCommon test(VacancyDraftTest test) {
    this.test = test;
    return this;
  }
  ...
  */
  ...
  public VacancyEditCommon workFormat(List<@Valid VacancyWorkFormatWorkFormatItem> workFormat) {
    this.workFormat = workFormat;
    return this;
  }

  public VacancyEditCommon addWorkFormatItem(VacancyWorkFormatWorkFormatItem workFormatItem) {
  ...
  */
  ...
  public VacancyEditCommon workScheduleByDays(List<@Valid VacancyWorkScheduleByDaysWorkScheduleByDaysItem> workScheduleByDays) {
    this.workScheduleByDays = workScheduleByDays;
    return this;
  }

  public VacancyEditCommon addWorkScheduleByDaysItem(VacancyWorkScheduleByDaysWorkScheduleByDaysItem workScheduleByDaysItem) {
  ...
  */
  ...
  public VacancyEditCommon workingDays(List<@Valid VacancyWorkingDayItem> workingDays) {
    this.workingDays = workingDays;
    return this;
  }

  public VacancyEditCommon addWorkingDaysItem(VacancyWorkingDayItem workingDaysItem) {
  ...
  */
  ...
  public VacancyEditCommon workingHours(List<@Valid VacancyWorkingHoursWorkingHoursItem> workingHours) {
    this.workingHours = workingHours;
    return this;
  }

  public VacancyEditCommon addWorkingHoursItem(VacancyWorkingHoursWorkingHoursItem workingHoursItem) {
  ...
  */
  ...
  public VacancyEditCommon workingTimeIntervals(List<@Valid VacancyWorkingTimeIntervalItem> workingTimeIntervals) {
    this.workingTimeIntervals = workingTimeIntervals;
    return this;
  }

  public VacancyEditCommon addWorkingTimeIntervalsItem(VacancyWorkingTimeIntervalItem workingTimeIntervalsItem) {
  ...
  */
  ...
  public VacancyEditCommon workingTimeModes(List<@Valid VacancyWorkingTimeModeItem> workingTimeModes) {
    this.workingTimeModes = workingTimeModes;
    return this;
  }

  public VacancyEditCommon addWorkingTimeModesItem(VacancyWorkingTimeModeItem workingTimeModesItem) {
  ...
  */
  ...
  public VacancyEditCommon description(String description) {
  ...
  */
  ...
  public VacancyEditCommon name(String name) {
    this.name = name;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    VacancyEditCommon vacancyEditCommon = (VacancyEditCommon) o;
    return Objects.equals(this.acceptHandicapped, vacancyEditCommon.acceptHandicapped) &&
        Objects.equals(this.acceptIncompleteResumes, vacancyEditCommon.acceptIncompleteResumes) &&
        Objects.equals(this.acceptKids, vacancyEditCommon.acceptKids) &&
        Objects.equals(this.acceptTemporary, vacancyEditCommon.acceptTemporary) &&
        Objects.equals(this.address, vacancyEditCommon.address) &&
        Objects.equals(this.ageRestriction, vacancyEditCommon.ageRestriction) &&
        Objects.equals(this.allowMessages, vacancyEditCommon.allowMessages) &&
        Objects.equals(this.brandedTemplate, vacancyEditCommon.brandedTemplate) &&
        Objects.equals(this.code, vacancyEditCommon.code) &&
        Objects.equals(this.contacts, vacancyEditCommon.contacts) &&
        Objects.equals(this.customEmployerName, vacancyEditCommon.customEmployerName) &&
        Objects.equals(this.department, vacancyEditCommon.department) &&
        Objects.equals(this.driverLicenseTypes, vacancyEditCommon.driverLicenseTypes) &&
        Objects.equals(this.employment, vacancyEditCommon.employment) &&
        Objects.equals(this.employmentForm, vacancyEditCommon.employmentForm) &&
        Objects.equals(this.experience, vacancyEditCommon.experience) &&
        Objects.equals(this.flyInFlyOutDuration, vacancyEditCommon.flyInFlyOutDuration) &&
        Objects.equals(this.internship, vacancyEditCommon.internship) &&
        Objects.equals(this.keySkills, vacancyEditCommon.keySkills) &&
        Objects.equals(this.languages, vacancyEditCommon.languages) &&
        Objects.equals(this.nightShifts, vacancyEditCommon.nightShifts) &&
        Objects.equals(this.professionalRoles, vacancyEditCommon.professionalRoles) &&
        Objects.equals(this.responseLetterRequired, vacancyEditCommon.responseLetterRequired) &&
        Objects.equals(this.responseNotifications, vacancyEditCommon.responseNotifications) &&
        Objects.equals(this.responseUrl, vacancyEditCommon.responseUrl) &&
        Objects.equals(this.salary, vacancyEditCommon.salary) &&
        Objects.equals(this.salaryRange, vacancyEditCommon.salaryRange) &&
        Objects.equals(this.schedule, vacancyEditCommon.schedule) &&
        Objects.equals(this.showContacts, vacancyEditCommon.showContacts) &&
        Objects.equals(this.test, vacancyEditCommon.test) &&
        Objects.equals(this.workFormat, vacancyEditCommon.workFormat) &&
        Objects.equals(this.workScheduleByDays, vacancyEditCommon.workScheduleByDays) &&
        Objects.equals(this.workingDays, vacancyEditCommon.workingDays) &&
        Objects.equals(this.workingHours, vacancyEditCommon.workingHours) &&
        Objects.equals(this.workingTimeIntervals, vacancyEditCommon.workingTimeIntervals) &&
        Objects.equals(this.workingTimeModes, vacancyEditCommon.workingTimeModes) &&
        Objects.equals(this.description, vacancyEditCommon.description) &&
        Objects.equals(this.name, vacancyEditCommon.name);
  }

  @Override
  public int hashCode() {
    return Objects.hash(acceptHandicapped, acceptIncompleteResumes, acceptKids, acceptTemporary, address, ageRestriction, allowMessages, brandedTemplate, code, contacts, customEmployerName, department, driverLicenseTypes, employment, employmentForm, experience, flyInFlyOutDuration, internship, keySkills, languages, nightShifts, professionalRoles, responseLetterRequired, responseNotifications, responseUrl, salary, salaryRange, schedule, showContacts, test, workFormat, workScheduleByDays, workingDays, workingHours, workingTimeIntervals, workingTimeModes, description, name);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class VacancyEditCommon {\n");
