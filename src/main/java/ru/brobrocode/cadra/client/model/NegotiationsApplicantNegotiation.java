...
public class NegotiationsApplicantNegotiation {
  ...
  private NegotiationsObjectsTopicResume resume = null;

  private String url;

  public NegotiationsApplicantNegotiation() {
    super();
  }
   ...
   */
  public NegotiationsApplicantNegotiation(String createdAt, Boolean hasUpdates, String id, String messagingStatus, IncludesIdName state, String updatedAt, Boolean viewedByOpponent, Boolean declineAllowed, Boolean hidden, String url) {
  ...
  public NegotiationsApplicantNegotiation applicantQuestionState(Boolean applicantQuestionState) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation counters(NegotiationsObjectsCounters counters) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation createdAt(String createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation hasUpdates(Boolean hasUpdates) {
    this.hasUpdates = hasUpdates;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation id(String id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation messagesUrl(String messagesUrl) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation messagingStatus(String messagingStatus) {
    this.messagingStatus = messagingStatus;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation professionalRoles(List<@Valid VacancyProfessionalRoleItem> professionalRoles) {
    this.professionalRoles = professionalRoles;
    return this;
  }

  public NegotiationsApplicantNegotiation addProfessionalRolesItem(VacancyProfessionalRoleItem professionalRolesItem) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation source(SourceEnum source) {
    this.source = source;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation state(IncludesIdName state) {
    this.state = state;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation updatedAt(String updatedAt) {
    this.updatedAt = updatedAt;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation viewedByOpponent(Boolean viewedByOpponent) {
    this.viewedByOpponent = viewedByOpponent;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation declineAllowed(Boolean declineAllowed) {
    this.declineAllowed = declineAllowed;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation hidden(Boolean hidden) {
    this.hidden = hidden;
    return this;
  }
  ...
  */
  ...
  public NegotiationsApplicantNegotiation jobSearchStatus(IncludesIdName jobSearchStatus) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation phoneCalls(NegotiationsPhoneCalls phoneCalls) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation tags(List<@Valid IncludesId> tags) {
    this.tags = tags;
    return this;
  }

  public NegotiationsApplicantNegotiation addTagsItem(IncludesId tagsItem) {
    if (this.tags == null) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation vacancy(VacanciesNegotiationsVacancyShort vacancy) {
  ...
  */
  ...
  public NegotiationsApplicantNegotiation resume(NegotiationsObjectsTopicResume resume) {
    this.resume = resume;
    return this;
  }
  ...
  */
  ...
  @JsonProperty("resume")
  public NegotiationsObjectsTopicResume getResume() {
    return resume;
  }

  public void setResume(NegotiationsObjectsTopicResume resume) {
    this.resume = resume;
  }

  public NegotiationsApplicantNegotiation url(String url) {
    this.url = url;
    return this;
  }
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    NegotiationsApplicantNegotiation negotiationsApplicantNegotiation = (NegotiationsApplicantNegotiation) o;
    return Objects.equals(this.applicantQuestionState, negotiationsApplicantNegotiation.applicantQuestionState) &&
        Objects.equals(this.counters, negotiationsApplicantNegotiation.counters) &&
        Objects.equals(this.createdAt, negotiationsApplicantNegotiation.createdAt) &&
        Objects.equals(this.hasUpdates, negotiationsApplicantNegotiation.hasUpdates) &&
        Objects.equals(this.id, negotiationsApplicantNegotiation.id) &&
        Objects.equals(this.messagesUrl, negotiationsApplicantNegotiation.messagesUrl) &&
        Objects.equals(this.messagingStatus, negotiationsApplicantNegotiation.messagingStatus) &&
        Objects.equals(this.professionalRoles, negotiationsApplicantNegotiation.professionalRoles) &&
        Objects.equals(this.source, negotiationsApplicantNegotiation.source) &&
        Objects.equals(this.state, negotiationsApplicantNegotiation.state) &&
        Objects.equals(this.updatedAt, negotiationsApplicantNegotiation.updatedAt) &&
        Objects.equals(this.viewedByOpponent, negotiationsApplicantNegotiation.viewedByOpponent) &&
        Objects.equals(this.declineAllowed, negotiationsApplicantNegotiation.declineAllowed) &&
        Objects.equals(this.hidden, negotiationsApplicantNegotiation.hidden) &&
        Objects.equals(this.jobSearchStatus, negotiationsApplicantNegotiation.jobSearchStatus) &&
        Objects.equals(this.phoneCalls, negotiationsApplicantNegotiation.phoneCalls) &&
        Objects.equals(this.tags, negotiationsApplicantNegotiation.tags) &&
        Objects.equals(this.vacancy, negotiationsApplicantNegotiation.vacancy) &&
        Objects.equals(this.resume, negotiationsApplicantNegotiation.resume) &&
        Objects.equals(this.url, negotiationsApplicantNegotiation.url);
  }

  @Override
  public int hashCode() {
    return Objects.hash(applicantQuestionState, counters, createdAt, hasUpdates, id, messagesUrl, messagingStatus, professionalRoles, source, state, updatedAt, viewedByOpponent, declineAllowed, hidden, jobSearchStatus, phoneCalls, tags, vacancy, resume, url);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class NegotiationsApplicantNegotiation {\n");
