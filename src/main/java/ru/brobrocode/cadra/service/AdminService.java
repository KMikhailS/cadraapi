...
public class AdminService {
	...
	public UserInfoDTO saveUser(UserInfoRequest userRequest) {
		...
		userInfo.setAuthCode(userRequest.getAuthCode());
		userInfo.setAccessToken(userRequest.getAccessToken());
		userInfo.setRefreshToken(userRequest.getRefreshToken());
		userInfo.setExpiresAt(userRequest.getExpiresAt());
